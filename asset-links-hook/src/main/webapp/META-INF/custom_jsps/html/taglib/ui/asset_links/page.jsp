<%--
    ...
    This is customized version of Inofix' custom-asset-links
    which includes a workaround a flussbad specific problem (see below)
    
    The original inofix version can be found here
