<#--
    ...
    Modified:   2016-06-11 14:24 by Christian Berndt
    Version:    1.2.6
...
<#if tags??>
    <#if tags.getData()?has_content>
        ...
        <#assign entries = assetSearchTool.search(companyId, groupIds, userId, permissionChecker, className, userName, title, description, assetCategoryIds, assetTagNames, anyTag, status, andSearch, start, end) />
    </#if>
</#if>  
